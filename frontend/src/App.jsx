      ...
      <header className="bg-white border-b-2 border-gray-200 py-5 shadow-sm">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="mt-3 pt-3 border-t border-gray-100">
            <h2 className="text-base font-bold tracking-widest text-gray-700 uppercase">
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
              <div className="px-6 py-4 bg-gray-50 border-b border-gray-200">
                ...
                <p className="text-xs text-gray-400 mt-0.5">
                  Internal operational data — not available in CMS database
                </p>
              </div>
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-1.5">
                    ...
                    <span className="ml-2 text-xs font-normal text-gray-400">
                      Optional — overrides CMS legal name in PDF
                    </span>
                  </label>
                  <input
                    type="text"
